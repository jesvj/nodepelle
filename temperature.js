...
function temp(sens, adc_value)
{
    if(sens == 'CTZ-01') //                # Udetemperaturføler
    {
        a, b, c = steinhart(-40, 345275, 30, 8050, 120, 388);
        r1 = 5600;
    ...
    {
        a, b, c = steinhart(-40, 345275, 40, 5314, 150, 177);
        r1 = 5600;
...
function calc(a, b, c, res, adc_reading)
{
...
function steinhart(t1, r1, t2, r2, t3, r3)
{
